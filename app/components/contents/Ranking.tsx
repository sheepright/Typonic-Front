...
export default function Ranking() {
  ...
  return (
    <div className="w-[940px] h-[579px] bg-[#1E1E1E] rounded-lg overflow-hidden shadow-lg border border-gray-700 font-dung">
      {/* 헤더 */}
      <div className="flex h-[35px] bg-[#2A2C2E] text-white text-sm font-light">
        ...
        <div className="w-[160px] flex items-center justify-center">Accuracy</div>
      ...
      <div className="overflow-y-auto h-[544px] scrollbar-hide">
        {rankingList.map((item, index) => {
          ...
          // 1~3등만 bold
          const fontWeight = index < 3 ? "font-bold" : "font-light";
          ...
          return (
            <div
              ...
              } text-sm ${rankColor} ${fontWeight}`}
            >
              <div className="w-[50px] flex items-center justify-center">{index + 1}</div>
              <div className="w-[340px] flex items-center pl-1">{item.username}</div>
              <div className="w-[100px] flex items-center justify-center">{item.vpm}</div>
              <div className="w-[100px] flex items-center justify-center">{item.time}</div>
              <div className="w-[160px] flex items-center justify-center">{item.accuracy}</div>
              <div className="w-[190px] flex items-center justify-center">{item.date}</div>
            </div>
          );
        })}
      </div>
