export default function Guide() {
  const guideInfoItems = [
    ...
    {
      box: "시작하기",
      text: ": 타자연습의 시작은 타이핑을 입력하는 시점부터 시작됩니다, 문장 또는 단어가 변경된 것을 확인 후 시작하여주세요.",
    },
    {
      box: "주의사항",
      text: ": 줄 바꿈은 Enter를 통해서 비어있는 칸만큼 줄바꿈을 진행해주시고 코드 앞 빈 공간은 TAB을 통해서 진행해주시면 됩니다.",
    },
    {
      box: "랭킹등록",
      text: ": 이름과 이메일 통해서 등록되며 자신의 이메일을 사용하여 등록하여 주세요. (이메일은 랭킹 저장시에 본인 확인용으로 사용됩니다.)",
    },
    {
      box: "랭킹보기",
